...
<a
	...
	class="inline-flex h-[22px] items-center gap-2 rounded-full bg-copper-lt px-3 font-mono text-[calc(var(--dt-base)*10.5/17)] font-medium tracking-[0.12em] text-copper-dk uppercase transition-colors hover:bg-copper-lt/80"
>
	...
	<svg
		...
		aria-hidden="true"
	>
		<path d="M3.5 1.5h5v5M8.5 1.5L3 7" />
	</svg>
</a>
