...
<a
	...
	class="inline-flex h-[22px] items-center gap-2 rounded-full bg-copper-lt px-3 font-mono text-eyebrow font-medium tracking-[0.12em] text-copper-dk uppercase transition-colors hover:bg-copper-lt/80"
>
