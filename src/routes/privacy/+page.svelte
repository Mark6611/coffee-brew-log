...
<article class="policy mx-auto max-w-[680px] px-[22px] pt-7 pb-16">
	<a
		href="/settings"
		class="text-muted hover:text-ink mb-6 inline-flex items-center gap-1 text-[14px] transition-colors"
	>
		<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M10 3L4 8l6 5" /></svg>
		Back
	</a>

	<h1 class="font-display text-ink text-[26px] font-medium tracking-[-0.01em]">Coffee Brew Log — Privacy Policy</h1>
	<p class="text-muted mt-1 mb-6 font-mono text-[12px] tracking-[0.04em]">Last updated: {updated}</p>
	...
	<ul>
		<li>
			<strong>Your bags and brews</strong> — roaster, origin, roast level, process, grind, dose,
			yield, brew time, ratings, tasting notes, prices, and dates — and your app
	...
	<p>
		...
		collect a device identifier, does not track you across apps or websites, and does not profile
		you.
	</p>
	...
	<h2>Children</h2>
	<p>Coffee Brew Log is not directed to children and does not knowingly collect information from children.</p>
